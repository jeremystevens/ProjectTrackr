#!/usr/bin/env python3
"""
Super minimal WSGI file to ensure clean MySQL initialization

This file avoids all the patching and dialect swapping that's causing issues
and instead creates a completely clean application instance.
"""
import os
import logging
