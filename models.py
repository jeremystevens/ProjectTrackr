"""
Database models with singleton pattern to prevent SQLAlchemy mapper conflicts.
"""
...
# Only define models if they haven't been initialized yet
if not _MODELS_INITIALIZED:
    # Mark as initialized first to prevent re-entry during import
    ...
    # Copy from your original models.py

# Function to mark models as registered
def register_models():
    """Mark all models as registered to prevent duplicate registration"""
    global _MODELS_INITIALIZED
    _MODELS_INITIALIZED = True

# Function to check if models are registered
def are_models_registered():
    """Check if models have been registered"""
